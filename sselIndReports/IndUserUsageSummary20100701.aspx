<%@ Page Title="User Usage Summary" Language="C#" MasterPageFile="~/IndReportsMaster.Master" AutoEventWireup="true" CodeBehind="IndUserUsageSummary20100701.aspx.cs" Inherits="sselIndReports.IndUserUsageSummary20100701" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div runat="server" id="divReportContent" visible="false">
        ...
        <div runat="server" id="divAggReports">
            ...
            <div id="divAggByAcc" class="section">
                ...
                <asp:ObjectDataSource ID="odsStoreAccount" runat="server" SelectMethod="GetDataByPeriodAndClientID" TypeName="StoreBillingByAccountBL">
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="ddlUser" Name="ClientID" PropertyName="SelectedValue" Type="Int32" />
                    </SelectParameters>
        ...
        <div id="divDetail" class="section">
            ...
            <h5>
                <asp:Label ID="lblRoom" runat="server"></asp:Label></h5>
            ...
            <h5>
                <asp:Label ID="lblTool" runat="server"></asp:Label></h5>
            <div id="divTool" runat="server" style="margin-left: 0px;">

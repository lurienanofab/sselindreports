<%@ Page Title="User Usage Summary" Language="C#" MasterPageFile="~/IndReportsMaster.Master" AutoEventWireup="true" CodeBehind="IndUserUsageSummary20220301.aspx.cs" Inherits="sselIndReports.IndUserUsageSummary20220301" %>
                ...
                <div class="tool-usage">
                    <div style="display: inline-block;">
                        ...
                        <asp:Repeater runat="server" ID="rptToolDetail">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td data-property="ResourceDisplayName" data-value='<%#Eval("ResourceDisplayName")%>' style="text-align: center;"><%#Eval("ResourceDisplayName")%></td>
                                    <td data-property="LabDisplayName" data-value='<%#Eval("LabDisplayName")%>' style="text-align: center;"><%#Eval("LabDisplayName")%></td>
                                    <td data-property="AccountName" data-value='<%#Eval("AccountName")%>' style="text-align: center;"><%#Eval("AccountName")%></td>
                                    <td data-property="ShortCode" data-value='<%#Eval("ShortCode")%>' style="text-align: center;"><%#Eval("ShortCode")%></td>
                                    <td data-property="BookingFee" data-value='<%#Eval("BookingFee")%>' style="text-align: center;"><%#Eval("BookingFee", "{0:C}")%></td>
                                    <td data-property="PerUseRate" data-value='<%#Eval("PerUseRate")%>' style="text-align: center;"><%#Eval("PerUseRate", "{0:C}")%></td>
                                    <td data-property="Uses" data-value='<%#Eval("Uses")%>' style="text-align: center;"><%#Eval("Uses", "{0:0.00}")%></td>
                        ...
                        <asp:Repeater runat="server" ID="zrptToolDetail">
                            <HeaderTemplate>
                                <table class="gridview striped" style="border-collapse: collapse;">
                                    <thead>
                                        <tr class="header">
